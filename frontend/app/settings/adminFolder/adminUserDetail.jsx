  ...
  return (
    <ThemedView style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={[styles.subUsername, { color: colors.text }]}>@{user.username}</Text>
...
const styles = StyleSheet.create({
  ...
  card: {
    width: "100%", backgroundColor: "#E3D5CA",
  ...
  deleteBtn: {
    ...
    width: "100%", borderWidth: 1, borderColor: "#e53935",
    borderRadius: 12, padding: 14,
  },
  deleteText: { fontSize: 16, fontWeight: "500", color: "#e53935" },
});