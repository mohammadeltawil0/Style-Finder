          ...
          >
              ...
              >
                <View style={{ flex: 1 }}>
                  ...
                  <ThemedText style={{ fontSize: 14 }}>
                    A {item.color ? item.color.toLowerCase() : ""}{" "}
                    {formatEnum(item.fit)} fit{" "}
                    {formatEnum(item.type).toLowerCase()} with a{" "}
                    {formatEnum(item.pattern)} pattern.
                  </ThemedText>
                  {item.imageUrl ? (
                    <Image
            ...
            <View style={styles.modalActions}>
              <TouchableOpacity
                ...
                onPress={() => onDelete(outfit.outfitId || outfit.id)}
              >
